; Made by TieLie(https://github.com/TieLie/)
; Brightness Control(made by qwerty12 (https://github.com/qwerty12/AutoHotkeyScripts/tree/master/LaptopBrightnessSetter))
...
class BrightnessSetter {
	...
	SetBrightness(increment, showOSD := True, autoDcOrAc := -1, ptrAnotherScheme := 0)
	{
